import Scroller from '../picker/static/scroller'
...
const TEMPLATE = `<div class="dp-container">
  <div class="dp-header">
    <div class="dp-item dp-left nuim-datetime-cancel" data-role="cancel">cancel</div>
    <div class="dp-item nuim-datetime-clear" data-role="clear"></div>
    <div class="dp-item dp-right nuim-datetime-confirm" data-role="confirm">ok</div>
  </div>
...
DatetimePicker.prototype = {
  ...
  _show(newValueMap) {
    ...
    if (this.renderInline) {
      self.container.classList.add('nuim-datetime-view')
    }
  ...
  show(value) {
    ...
    if (config.isOneInstance) {
      if (document.querySelector('#nuim-datetime-instance')) {
        return
      }
      self.willShow = true
    }
    ...
    if (self.container) {
      ...
      if (config.isOneInstance) {
        container.id = 'nuim-datetime-instance'
      }
