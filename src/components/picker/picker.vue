...
<script>
import Scroller from './static/scroller'
import Manager from './static/chain'
...
export default {
  ...
  methods: {
    ...
    getId (i) {
      return `#nuim-picker-${this.uuid}-${i}`
    },
    render (data, value) {
