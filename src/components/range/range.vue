<template>
  <div class="nuim-range-input-box" style="position:relative;margin-right:30px;margin-left:50px;">
    <input class="nuim-range-input" v-model.number="currentValue">
  </div>
</template>

<script>
import Powerange from './range/libs/powerange'
...
export default {
  ...
  mounted () {
    ...
    this.$nextTick(() => {
      ...
      this.range = new Powerange(this.$el.querySelector('.nuim-range-input'), options)
