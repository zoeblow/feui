...
.inline-calendar td > span.nuim-calendar-each-date {
  position: relative;
  display: inline-block;
...
.inline-calendar td.current > span.nuim-calendar-each-date {
