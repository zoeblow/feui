...
<script>
import array2string from './../../libs/array2String'
...
.nuim-popup-picker-header-menu {
  text-align: left;
  padding-left: 15px;
  line-height: 44px;
}
.nuim-popup-picker-header-menu-right {
  text-align: right;
  padding-right: 15px;
}
.nuim-popup-picker-select {
  width: 100%;
  position: relative;
}
.nuim-popup-picker-select-box.weui-cell__bd:after {
  content: " ";
  display: inline-block;
