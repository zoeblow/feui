...
<script>
import { parentMixin } from '../../libs/multi-items'
...
.nuim-tab .nuim-tab-item.nuim-tab-selected {
  color: @tab-text-active-color;
  border-bottom: 3px solid @tab-text-active-color;
}

.nuim-tab .nuim-tab-item.nuim-tab-disabled {
  color: @tab-text-disabled-color;
}

.nuim-tab.nuim-tab-no-animate .nuim-tab-item.nuim-tab-selected {
  background: 0 0;
}
