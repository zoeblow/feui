...
.nuim-x-input .nuim-x-input-placeholder-right input::-webkit-input-placeholder {
  text-align: right;
}
.nuim-x-input .nuim-x-input-placeholder-center input::-webkit-input-placeholder {
  text-align: center;
}
.nuim-x-input .nuim-input-icon {
  font-size: 21px;
}
.nuim-input-icon.weui-icon-warn:before, .nuim-input-icon.weui-icon-success:before {
  font-size: 21px;
}
.nuim-x-input .weui-icon {
  padding-left: 5px;
}
.nuim-x-input.weui-cell_vcode {
  padding-top: 0;
  padding-right: 0;
  padding-bottom: 0;
}
