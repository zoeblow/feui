  ...
  <div class="page">
    ...
    <div class="fe-content">
      ...
      <fe-swiper auto height="30px" direction="vertical" :interval=2000 class="text-scroll" :show-dots="false">
        <swiper-item><p>向着网络强国新时代昂首迈进</p></swiper-item>
        <swiper-item><p>国际政要点赞“中国梦”  领航新征程</p></swiper-item>
        <swiper-item><p>一个万亿级公司诞生：33万名员工、创四个世界之最</p></swiper-item>
        <swiper-item><p>奇葩！出狱不到十天再被抓 只因看守所有吃有喝</p></swiper-item>
        <swiper-item><p>传A站已被关停：没钱交电费被拉闸</p></swiper-item>
        <swiper-item><p>比尔盖茨凭什么能当中国工程院院士？</p></swiper-item>
      </fe-swiper>
      <br>
